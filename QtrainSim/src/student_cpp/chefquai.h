...
public:
    ...
    bool isDispo(int numeroTrain , int nextPoint, int sens){
        ...
        if(sens == 1){
            ...
            if(nextPoint == secCrit.at(0).at(0)){ // section critique 1
                if(secCrit.at(0).at(2) == 0 || secCrit.at(0).at(3) == numeroTrain){
                    secCrit.at(0).at(2) = 1;
            ...
            if(nextPoint == secCrit.at(0).at(1)){ // section critique 1
                if(secCrit.at(0).at(2) == 0 || secCrit.at(0).at(3) == numeroTrain){
                    secCrit.at(0).at(2) = 1;
                    secCrit.at(0).at(3) = numeroTrain;
                    ok = true;
            ...
            else if(nextPoint == secCrit.at(1).at(1) ){ // section critique 2
                if(secCrit.at(1).at(2) == 0|| secCrit.at(1).at(3) == numeroTrain){
                    secCrit.at(1).at(2) = 1;
                    secCrit.at(1).at(3) = numeroTrain;
                    ok = true;
    ...
    void changeSegment(int numeroTrain, int last, int sens){
        ...
        if(sens == 1){
            ...
            if(last == secCrit.at(0).at(0)){
                secCrit.at(0).at(2) = 0;
                secCrit.at(0).at(3) = -1;
            }
            else if(last == secCrit.at(1).at(0)){
                secCrit.at(1).at(2) = 0;
                secCrit.at(1).at(3) = -1;
            }
        }
